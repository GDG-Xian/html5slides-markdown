...
var PERMANENT_URL_PREFIX = 'http://gdg-xian.github.io/html5slides-markdown/';
...
function addPrettify() {
  ...
  el.src = PERMANENT_URL_PREFIX + 'javascripts/prettify.js';
  el.onload = function() {
    prettyPrint();
  }
...
function addGeneralStyle() {
  ...
  el.rel = 'stylesheet';
  el.type = 'text/css';
  el.href = PERMANENT_URL_PREFIX + 'themes/default.css';
  document.body.appendChild(el);
